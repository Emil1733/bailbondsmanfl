...
Treat all fixes equally: Code changes (_.tsx, _.ts) and content changes (_.md, _.mdx, \*.html) are equally important. Don't stop after code fixes.
...
Content File Fixes
Many issues require editing content files (_.md, _.mdx). These are equally important as code fixes:
...
Install squirrel: curl -fsSL https://squirrelscan.com/install | bash
