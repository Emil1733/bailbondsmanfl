...
export const metadata: Metadata = pageMetadata({
    title: "Lee County Jail Core Facility Guide",
    description: "Find the Lee County Jail Core Facility address, phone number, official inmate-search resource, booking details, visitor information, and release guidance.",
...
export default function LeeCountyCoreFacilityPage() {
    ...
    const combinedFaqs = [
        {
            question: "Where do I post bail for someone at Lee County Core Facility?",
            answer: "Bail bonds for Lee County Core Facility must be posted at the main booking desk lobby located at 2501 Ortiz Ave, Fort Myers, FL 33905. The bail window is open 24/7. Our licensed bail bondsman can handle the entire process electronically or meet you at the facility, so you do not have to wait in line at the jail cash window."
        },
        {
            question: "How long does booking take at the Lee County Core Facility in Fort Myers?",
            answer: "Booking at Lee County Core Facility typically takes 4 to 8 hours depending on booking volume, staffing, and shift change holds. The facility serves as the primary intake and processing hub for all Lee County arrests, which leads to high traffic. We recommend starting the bail bond paperwork immediately so the bond can be posted as soon as the inmate receives their booking number."
        },
        {
            question: "What is the release time after posting bond at Lee?",
            answer: "Once the surety bond is accepted and processed by the Lee booking desk, release typically takes between 6 and 12 hours. The jail release lobby is open 24/7, and our local bondsman will monitor the discharge status and notify you when it is time to pick them up."
        },
        {
            question: "Can I pay for a bail bond at Lee County Core Facility online?",
            answer: "Yes. Our digital E-Bonding service allows you to complete the credit application and pay the 10% premium via credit card, debit card, or wire transfer from your phone. Our bondsman will immediately file the surety bond with the Lee booking desk electronically."
        },
        {
            question: "What is the statutory bail bond fee in Lee County?",
    ...
    "sections": [
        {
            "id": "booking",
            "title": "Fort Myers Central Intake",
            "icon": "AlertCircle",
            "content": [
        ...
        {
            "id": "hearings",
            "title": "20th Circuit Magistrate Procedures",
            "icon": "Scale",
            "content": [
        ...
        {
            "id": "facility",
            "title": "Lee County Facility Rules",
            "icon": "Info",
            "content": [
    ...
    return (
        <main className="min-h-screen bg-slate-950 flex flex-col font-sans text-slate-200">
            ...
            {/* HERO */}
            <Hero
                title={<span className="font-serif text-white">Lee County Core Facility <span className="text-yellow-500">Bail Bonds</span></span>}
                subtitle="24/7 Emergency Jail Release — Fort Myers-Dade Primary Intake Specialists"
                ...
                <ContentContainer>
                    <Breadcrumbs
                        items={[
                            ...
                            { label: "Lee County Core Facility", href: "/jail/lee-county-core-facility" }
                        ]}
                    />
                    <div className="grid lg:grid-cols-12 gap-16 items-start">
                        ...
                        <div className="lg:col-span-7 space-y-12">
                            ...
                            <div className="bg-red-950/20 border-l-4 border-red-500 p-8 rounded-r-lg">
                                ...
                                <p className="text-lg text-slate-300 leading-relaxed mb-6">
                                    Need immediate **Lee County Core Facility Bail Bonds**? Speak with a licensed bondsman 24/7. Turner Guilford Knight (Lee) is the primary intake center for all Lee County arrests. If your loved one is arrested by the Fort Myers Police Department, MDPD, or local municipal agencies, they will be transported here immediately.
                                </p>
                            ...
                            <article className="prose prose-invert max-w-none space-y-6">
                                <h2 className="text-3xl font-serif font-bold text-white border-l-4 border-yellow-500 pl-6">
                                    Understanding the Lee County Core Facility Booking Process
                                </h2>
                                <p className="text-slate-300 leading-relaxed">
                                    Lee County Core Facility, located at 2501 Ortiz Ave, Fort Myers, FL 33905, is a 1,300-bed direct supervision facility operated by the Fort Myers-Dade Corrections and Rehabilitation Department. It serves as the primary processing center for adult males and females arrested in Lee County.
                                </p>
                                <p className="text-slate-300 leading-relaxed">
                            ...
                            <div className="space-y-6">
                                ...
                                <p className="text-slate-300 leading-relaxed">
                                    Lee is conveniently located in Doral, just north of Fort Myers International Airport, with quick access from the Palmetto Expressway (SR-826) and the Dolphin Expressway (SR-836).
                                </p>
                                <div className="grid md:grid-cols-2 gap-6 pt-4">
                                    ...
                                    <div className="bg-slate-900 border border-slate-800 p-6 rounded-lg">
                                        ...
                                        <p className="text-sm text-slate-400">
                                            ...
                                            7 Days a Week<br />
                                            Fort Myers-Dade Corrections Desk
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <article className="prose prose-invert max-w-none space-y-6">
                                <h2 className="text-3xl font-serif font-bold text-white border-l-4 border-yellow-500 pl-6">
                                    Clearing Warrants at Lee County Core Facility
                                </h2>
                                <p className="text-slate-300 leading-relaxed">
                                    If you have an active warrant in Lee County, do not wait to get arrested. We offer a specialized **Walk-Through Warrant Bond** service. We coordinate with you, draft the bond paperwork in advance, and meet you at the Lee lobby.
                                </p>
                                <p className="text-slate-300 leading-relaxed">
                            ...
                            <article className="prose prose-invert max-w-none space-y-6">
                                ...
                                <p className="text-slate-300 leading-relaxed">
                                    We provide fully remote digital E-Bonding for Lee County Core Facility. Using your smartphone or computer, you can complete all application documents, verify your identity, and pay the 10% premium via credit card or wire transfer.
                                </p>
                                <p className="text-slate-300 leading-relaxed">
                                    Once completed, we transmit the surety bond electronically directly to the Lee booking desk. The jail begins the release sequence immediately, and you can simply meet your loved one at the release lobby, eliminating the need to travel to our office or wait in line at the jail.
                                </p>
                            </article>
                            ...
                            <div className="bg-slate-900 border border-slate-800 p-8 rounded-xl space-y-6">
                                <h3 className="text-2xl font-serif font-bold text-white flex items-center gap-2">
                                    ...
                                    Lee County Core Facility Release Checklist
                                </h3>
                                <ul className="space-y-4 text-slate-300">
                                    ...
                                    <li className="flex gap-3 items-start">
                                        ...
                                        <div>
                                            <strong>Call Our Agent:</strong> Speak with a licensed Fort Myers bondsman at (305) 831-0358 to confirm the bond amount.
                                        </div>
                                    </li>
                                    <li className="flex gap-3 items-start">
                                    ...
                                    <li className="flex gap-3 items-start">
                                        ...
                                        <div>
                                            <strong>Bond Submission:</strong> We submit the surety bond directly to the Lee booking window.
                                        </div>
                                    </li>
                                    <li className="flex gap-3 items-start">
                                        ...
                                        <div>
                                            <strong>Discharge:</strong> Meet the defendant at the main Lee release lobby. Release times vary from 4 to 8 hours.
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="lg:col-span-5 space-y-12">
                            ...
                            <div className="border border-slate-800 bg-slate-900 h-[300px] grayscale hover:grayscale-0 transition-all duration-700 relative group">
                                ...
                                <div className="absolute bottom-4 left-4 right-4 bg-slate-900/90 p-4 border border-slate-700 backdrop-blur-sm">
                                    ...
                                    <div className="text-white font-bold flex items-center gap-2">
                                        ...
                                        Primary Booking Hub (Lee Fort Myers)
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="border-t border-slate-800 pt-12">
                                <FAQSection countyName="Lee County Core Facility" customFaqs={combinedFaqs} />
                            </div>

                            {/* Local Navigation Links */}
                            <div className="border-t border-slate-800 pt-12">
                                <h3 className="text-sm font-bold uppercase tracking-widest text-slate-500 mb-4">Other Fort Myers Facilities</h3>
                                <div className="flex flex-col gap-3">
                                    <Link href="/county/miami-dade" className="text-sm text-yellow-600 hover:text-white transition-colors">
                                        Lee County Directory &rarr;
                                    </Link>
                                </div>
                            </div>
...
{/* Sticky Urgency CTA */}
                            <div className="bg-yellow-500 p-8 rounded-2xl text-black shadow-2xl sticky top-8">
                                ...
                                <p className="text-[10px] uppercase font-black tracking-widest mt-6 text-center opacity-70">
                                    Serving Lee County and All Florida Jails
                                </p>
                            </div>
            ...
            <JailLocalLinks jailSlug="lee-county-core-facility" />
            <MobileFloatingCall />
        </main>
    );
}
