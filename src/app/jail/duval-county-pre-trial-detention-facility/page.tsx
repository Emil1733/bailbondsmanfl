...
export const metadata: Metadata = {
    title: "Duval County Pre-Trial Detention Facility Bail Bonds Jacksonville | 24/7 Fast Release",
    description: "Need immediate bail bonds for Duval County Pre-Trial Detention Facility in Jacksonville, FL? Speak with a licensed bondsman 24/7. Fast inmate release. 10% rates & online payment plans.",
    alternates: {
...
export default function DuvalCountyPreTrialDetentionFacilityPage() {
    ...
    const combinedFaqs = [
        {
            question: "Where do I post bail for someone at Duval County Pre-Trial Detention Facility?",
            answer: "Bail bonds for Duval County Pre-Trial Detention Facility must be posted at the main booking desk lobby located at 500 E Adams St, Jacksonville, FL 32202. The bail window is open 24/7. Our licensed bail bondsman can handle the entire process electronically or meet you at the facility, so you do not have to wait in line at the jail cash window."
        },
        {
            question: "How long does booking take at the Duval County Pre-Trial Detention Facility in Jacksonville?",
            answer: "Booking at Duval County Pre-Trial Detention Facility typically takes 6 to 10 hours depending on booking volume, staffing, and shift change holds. The facility serves as the primary intake and processing hub for all Duval County arrests, which leads to high traffic. We recommend starting the bail bond paperwork immediately so the bond can be posted as soon as the inmate receives their booking number."
        },
        {
            question: "What is the release time after posting bond at Duval?",
            answer: "Once the surety bond is accepted and processed by the Duval booking desk, release typically takes between 6 and 12 hours. The jail release lobby is open 24/7, and our local bondsman will monitor the discharge status and notify you when it is time to pick them up."
        },
        {
            question: "Can I pay for a bail bond at Duval County Pre-Trial Detention Facility online?",
            answer: "Yes. Our digital E-Bonding service allows you to complete the credit application and pay the 10% premium via credit card, debit card, or wire transfer from your phone. Our bondsman will immediately file the surety bond with the Duval booking desk electronically."
        },
        {
            question: "What is the statutory bail bond fee in Duval County?",
    ...
    "sections": [
        {
            "id": "booking",
            "title": "JSO Intake and Processing",
            "icon": "AlertCircle",
            "content": [
        ...
        {
            "id": "hearings",
            "title": "4th Judicial Circuit Hearings",
            "icon": "Scale",
            "content": [
        ...
        {
            "id": "facility",
            "title": "Jacksonville Facility Operations",
            "icon": "Info",
            "content": [
    ...
    return (
        <main className="min-h-screen bg-slate-950 flex flex-col font-sans text-slate-200">
            ...
            {/* HERO */}
            <Hero
                title={<span className="font-serif text-white">Duval County Pre-Trial Detention Facility <span className="text-yellow-500">Bail Bonds</span></span>}
                subtitle="24/7 Emergency Jail Release — Jacksonville-Dade Primary Intake Specialists"
                ...
                <ContentContainer>
                    <Breadcrumbs
                        items={[
                            ...
                            { label: "Duval County Pre-Trial Detention Facility", href: "/jail/duval-county-pre-trial-detention-facility" }
                        ]}
                    />
                    <div className="grid lg:grid-cols-12 gap-16 items-start">
                        ...
                        <div className="lg:col-span-7 space-y-12">
                            ...
                            <div className="bg-red-950/20 border-l-4 border-red-500 p-8 rounded-r-lg">
                                ...
                                <p className="text-lg text-slate-300 leading-relaxed mb-6">
                                    Need immediate **Duval County Pre-Trial Detention Facility Bail Bonds**? Speak with a licensed bondsman 24/7. Turner Guilford Knight (Duval) is the primary intake center for all Duval County arrests. If your loved one is arrested by the Jacksonville Police Department, MDPD, or local municipal agencies, they will be transported here immediately.
                                </p>
                            ...
                            <article className="prose prose-invert max-w-none space-y-6">
                                <h2 className="text-3xl font-serif font-bold text-white border-l-4 border-yellow-500 pl-6">
                                    Understanding the Duval County Pre-Trial Detention Facility Booking Process
                                </h2>
                                <p className="text-slate-300 leading-relaxed">
                                    Duval County Pre-Trial Detention Facility, located at 500 E Adams St, Jacksonville, FL 32202, is a 1,300-bed direct supervision facility operated by the Jacksonville-Dade Corrections and Rehabilitation Department. It serves as the primary processing center for adult males and females arrested in Duval County.
                                </p>
                                <p className="text-slate-300 leading-relaxed">
                            ...
                            <div className="space-y-6">
                                ...
                                <p className="text-slate-300 leading-relaxed">
                                    Duval is conveniently located in Doral, just north of Jacksonville International Airport, with quick access from the Palmetto Expressway (SR-826) and the Dolphin Expressway (SR-836).
                                </p>
                                <div className="grid md:grid-cols-2 gap-6 pt-4">
                                    ...
                                    <div className="bg-slate-900 border border-slate-800 p-6 rounded-lg">
                                        ...
                                        <p className="text-sm text-slate-400">
                                            ...
                                            7 Days a Week<br />
                                            Jacksonville-Dade Corrections Desk
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <article className="prose prose-invert max-w-none space-y-6">
                                <h2 className="text-3xl font-serif font-bold text-white border-l-4 border-yellow-500 pl-6">
                                    Clearing Warrants at Duval County Pre-Trial Detention Facility
                                </h2>
                                <p className="text-slate-300 leading-relaxed">
                                    If you have an active warrant in Duval County, do not wait to get arrested. We offer a specialized **Walk-Through Warrant Bond** service. We coordinate with you, draft the bond paperwork in advance, and meet you at the Duval lobby.
                                </p>
                                <p className="text-slate-300 leading-relaxed">
                            ...
                            <article className="prose prose-invert max-w-none space-y-6">
                                ...
                                <p className="text-slate-300 leading-relaxed">
                                    We provide fully remote digital E-Bonding for Duval County Pre-Trial Detention Facility. Using your smartphone or computer, you can complete all application documents, verify your identity, and pay the 10% premium via credit card or wire transfer.
                                </p>
                                <p className="text-slate-300 leading-relaxed">
                                    Once completed, we transmit the surety bond electronically directly to the Duval booking desk. The jail begins the release sequence immediately, and you can simply meet your loved one at the release lobby, eliminating the need to travel to our office or wait in line at the jail.
                                </p>
                            </article>
                            ...
                            <div className="bg-slate-900 border border-slate-800 p-8 rounded-xl space-y-6">
                                <h3 className="text-2xl font-serif font-bold text-white flex items-center gap-2">
                                    ...
                                    Duval County Pre-Trial Detention Facility Release Checklist
                                </h3>
                                <ul className="space-y-4 text-slate-300">
                                    ...
                                    <li className="flex gap-3 items-start">
                                        ...
                                        <div>
                                            <strong>Call Our Agent:</strong> Speak with a licensed Jacksonville bondsman at (305) 831-0358 to confirm the bond amount.
                                        </div>
                                    </li>
                                    <li className="flex gap-3 items-start">
                                    ...
                                    <li className="flex gap-3 items-start">
                                        ...
                                        <div>
                                            <strong>Bond Submission:</strong> We submit the surety bond directly to the Duval booking window.
                                        </div>
                                    </li>
                                    <li className="flex gap-3 items-start">
                                        ...
                                        <div>
                                            <strong>Discharge:</strong> Meet the defendant at the main Duval release lobby. Release times vary from 6 to 10 hours.
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div className="lg:col-span-5 space-y-12">
                            ...
                            <div className="border border-slate-800 bg-slate-900 h-[300px] grayscale hover:grayscale-0 transition-all duration-700 relative group">
                                ...
                                <div className="absolute bottom-4 left-4 right-4 bg-slate-900/90 p-4 border border-slate-700 backdrop-blur-sm">
                                    ...
                                    <div className="text-white font-bold flex items-center gap-2">
                                        ...
                                        Primary Booking Hub (Duval Jacksonville)
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="border-t border-slate-800 pt-12">
                                <FAQSection countyName="Duval County Pre-Trial Detention Facility" customFaqs={combinedFaqs} />
                            </div>

                            {/* Local Navigation Links */}
                            <div className="border-t border-slate-800 pt-12">
                                <h3 className="text-sm font-bold uppercase tracking-widest text-slate-500 mb-4">Other Jacksonville Facilities</h3>
                                <div className="flex flex-col gap-3">
                                    <Link href="/county/miami-dade" className="text-sm text-yellow-600 hover:text-white transition-colors">
                                        Duval County Directory &rarr;
                                    </Link>
                                </div>
                            </div>
...
{/* Sticky Urgency CTA */}
                            <div className="bg-yellow-500 p-8 rounded-2xl text-black shadow-2xl sticky top-8">
                                ...
                                <p className="font-bold mb-8 opacity-90">
                                    Speak directly to a licensed Jacksonville surety agent. Open 24 hours.
                                </p>
                                ...
                                <p className="text-[10px] uppercase font-black tracking-widest mt-6 text-center opacity-70">
                                    Serving Duval County and All Florida Jails
                                </p>
                            </div>
